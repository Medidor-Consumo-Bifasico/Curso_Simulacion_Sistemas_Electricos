...
#define myChannelNumber 1601576
#define myWriteAPIKey "8RQQDGV1BEIQZXZG"
...
void loop() { //Loop infinito
  ...
  ThingSpeak.setField(3, DatosFaseA.corriente);
  ThingSpeak.setField(4, DatosFaseB.corriente);
  ThingSpeak.setField(5, DatosFaseA.potencia);
  ThingSpeak.setField(6, DatosFaseB.potencia);
  ThingSpeak.setField(7, DatosFaseA.energia);
  ThingSpeak.setField(8, DatosFaseB.energia);
